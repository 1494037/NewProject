...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){ // 화면에 보일 뷰 만듬
        ...
        menu_title = (EditText)rootView.findViewById(R.id.add_menu_name);
        menu_price = (EditText)rootView.findViewById(R.id.add_menu_price);
        menu_explain = (EditText)rootView.findViewById(R.id.add_menu_explain);
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(
                ...
                new int[]{R.id.menu_image, R.id.menu_name, R.id.menu_price},
                0
        );
